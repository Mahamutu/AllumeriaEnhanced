...
API_URL="https://api.github.com/repos/$RepoUser/$RepoName/releases/latest"
echo "Checking for latest release..."

RELEASE_JSON=$(curl -fsSL -A "$USER_AGENT" -H "Accept: application/vnd.github.v3+json" "$API_URL")

# Safe extraction of download URL without requiring 'jq'
